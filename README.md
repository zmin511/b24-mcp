...
## Deploy on Ubuntu (example: <MCP_BASE_URL>)
- Run with docker-compose, expose port `7010` to localhost only, then proxy via Nginx/Caddy to `https://<MCP_BASE_URL>/b24/mcp`
